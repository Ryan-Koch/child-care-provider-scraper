...
class UtahSpiderTest(unittest.TestCase):
    ...
    def test_parse_search(self):
        ...
        response = TextResponse(url=request.url, request=request, body=json.dumps(search_json), encoding="utf-8")
    ...
    def test_parse_detail(self):
        ...
        response = TextResponse(url=request.url, request=request, body=json.dumps(detail_json), encoding="utf-8")
