...
class NewYorkSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        yield scrapy.Request(url=self.start_url, method="POST", headers=headers, body=body, callback=self.parse)
    ...
    def parse(self, response):
        ...
        for row in reader:
            ...
            address_parts = [
                part for part in [street_number, street_name, additional_address, floor, apartment] if part
            ]
